 ...
 */
 export function EXPECTED_OVEN_TIME(expectedTimeInOven) {
...
export function preparationTimeInMinutes(numberOfLayers) {
  let result1 = PREPARATION_MINUTES_PER_LAYER*numberOfLayers
  return result1;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let totalTime = preparationTimeInMinutes(numberOfLayers)
